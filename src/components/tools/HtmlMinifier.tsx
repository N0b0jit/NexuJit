            ...
            <div className="minifier-layout">
                <div className="editor-panel">
                    <div className="panel-header">
                        <label><FileCode size={16} /> Paste HTML Code</label>
                    ...
                    <textarea
                        ...
                        spellCheck={false}
                    />
                    <button onClick={minifyHtml} className="minify-btn" disabled={!input}>
                        <Zap size={18} /> Minify HTML Now
                    </button>
                </div>
                ...
                <div className="result-panel">
                    ...
                    <div className="info-box">
                        <Info size={16} />
                        <p>This tool removes comments and redundant whitespaces for faster page load speeds.</p>
                    </div>
                </div>
            </div>

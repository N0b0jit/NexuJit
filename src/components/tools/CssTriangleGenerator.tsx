    ...
    return (
        <div className="tool-ui">
            ...
            <style jsx>{`
                ...
                .preview-area { height: 400px; background: var(--surface); border-radius: 1.5rem; border: 1px solid var(--border); display: flex; align-items: center; justify-content: center; background-image: radial-gradient(var(--border) 1px, transparent 1px); background-size: 20px 20px; }

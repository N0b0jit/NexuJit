    ...
    return (
        <div className="tool-ui">
            ...
            <style jsx>{`
                ...
                .live-preview img { max-width: 100%; max-height: 600px; background: white; box-shadow: 0 10px 40px rgba(0,0,0,0.2); }
                ...
                .control-card { background: white; border: 1px solid var(--border); border-radius: 1.25rem; padding: 1.5rem; display: flex; flex-direction: column; gap: 1.5rem; }

    ...
    return (
        <div className="tool-ui">
            ...
            <style jsx>{`
                ...
                .twitter-card { border: 1px solid #e1e8ed; border-radius: 1rem; overflow: hidden; background: white; max-width: 500px; cursor: pointer; transition: box-shadow 0.2s; margin-bottom: 2rem; }

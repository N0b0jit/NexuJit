    ...
    return (
        <div className="tool-ui">
            ...
            <style jsx>{`
                ...
                .preview-stage { height: 300px; background: var(--surface); border-radius: 2rem; border: 1px solid var(--border); display: flex; align-items: center; justify-content: center; }

    ...
    return (
        <div className="tool-ui">
            ...
            <style jsx>{`
                ...
                .preview-box { background: white; border-radius: 1rem; padding: 1rem; display: flex; align-items: center; justify-content: center; min-height: 200px; border: 1px solid var(--border); }
                ...
                .png-result img { max-width: 100%; border-radius: 0.5rem; box-shadow: 0 10px 30px rgba(0,0,0,0.1); background: white; }

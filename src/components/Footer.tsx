                        ...
                        <div className="flex gap-4">
                            {[Twitter, Github, Linkedin, MessageCircle].map((Icon, i) => (
                                <Link
                                    key={i}
                                    href="#"
                                    className="w-10 h-10 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex items-center justify-center text-fg-tertiary hover:border-accent hover:text-accent hover:shadow-lg transition-all"
                                >
                                    <Icon size={18} />
                                </Link>
                            ))}
                    ...
                    <div className="lg:col-span-4">
                        <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-8 shadow-sm">
                            ...
                            <div className="space-y-3">
                                <a
                                    href={`https://wa.me/8801615999193?text=${encodeURIComponent(`Hello NexuJit Team! I have a feature request/feedback.\n\nTimestamp: ${new Date().toLocaleString()}`)}`}
                                    target="_blank"

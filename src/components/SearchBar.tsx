    ...
    <div className="relative w-full" ref={searchRef} onKeyDown={handleKeyDown}>
      <div className="relative group">
        ...
        <input
          ...
          className={`
            w-full bg-slate-100/40 dark:bg-bg-tertiary/20 backdrop-blur-xl border-2 border-transparent rounded-[1.25rem] md:rounded-[2rem] outline-none transition-all duration-500
            placeholder:text-fg-tertiary/60 font-black focus:ring-[12px] focus:ring-accent/5 focus:border-accent/20
          ...
          <AnimatePresence>
            {query && (
              <motion.button
                ...
                onClick={() => setQuery('')}
                className="p-2 hover:bg-slate-200 dark:hover:bg-slate-800 rounded-full text-fg-tertiary transition-colors"
              >

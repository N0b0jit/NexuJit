...
export const categories = [
    ...
    },
    {
        ...
        tools: [
            ...
            { name: 'Emoji Crypt', href: '/tools/emoji-crypt', description: 'Hide secret messages inside emojis using steganography.' },
    ...
    },
    {
        ...
        tools: [
            { name: 'MeluaPlayer', href: '/tools/meluaplayer', description: 'Instant online video player with gesture controls and auto-fullscreen.' },
